...
});if(k){l.trigger("goto",[0])}}};PHORK.utils.notify=e;var f={authorize:function(i){return i+(authorize?"?sid="+g.get("PHPSESSID"):"")},error:function(l,i,j){try{if(l.responseText){if(data=$.parseJSON(l.responseText)){errors=data.errors
