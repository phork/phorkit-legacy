<?php
	...
	/**
	 * FacebookModel.class.php
	 * 
	 * Used to add, edit, delete and load the facebook records
	 ...
	 * @subpackage models
	 */
	class FacebookModel extends CoreDatabaseModel {
		
		protected $strTable = 'facebook';
		protected $strPrimaryKey = 'facebookid';
		
		protected $arrInsertCols = array('userid', 'externalid', 'sessionkey', 'secret', 'token', 'firstname', 'lastname', 'email', 'location', 'gender', 'url', 'created');
		protected $arrUpdateCols = array('userid', 'sessionkey', 'secret', 'token');
